...
# CUMA 1.100.30 - Windows one-folder autocontido.
...
exe = EXE(pyz, a.scripts, [], exclude_binaries=True, name='cuma', debug=False,
          bootloader_ignore_signals=False, strip=False, upx=True, console=False, icon='app_icon.ico')
...
coll = COLLECT(exe, updater_exe, a.binaries, a.datas, strip=False, upx=True, upx_exclude=[], name='CUMA_windows')
